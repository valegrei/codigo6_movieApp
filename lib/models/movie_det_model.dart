...
//
//     final movieDetModel = movieDetModelFromJson(jsonString);

import 'dart:convert';

MovieDetModel movieDetModelFromJson(String str) => MovieDetModel.fromJson(json.decode(str));

String movieDetModelToJson(MovieDetModel data) => json.encode(data.toJson());
...
class MovieDetModel {
  ...
  factory MovieDetModel.fromJson(Map<String, dynamic> json) => MovieDetModel(
    adult: json["adult"],
